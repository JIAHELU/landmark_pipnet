...
def t_img():
    img_path ='/data/cv/jiahe.lu/nniefacelib/PFPLD-Dataset/test_data/imgs/190_10219153795_0_0.png'
    ...
    for i in range(len(result)):
        ...
        cv2.imwrite(f'./test_related/pre-annotation/show_label_{i}.jpg', cropped)
...
def t_file():
    images_path = '/home/bill/E/dl_base2/nniefacelib/PFPLD/test_related/data'
    out_path ='/home/bill/E/dl_base2/nniefacelib/PFPLD/test_related/data_out'
    ...
    for img_path in path_list:
        ...
        save_name_ =out_path + '/' +save_name
        cv2.imwrite(save_name_ ,img)
